...
The dataset includes the following columns: ["date", "code", "open", "high", "low", "close", "change", "decision", "hold_num", "cash", "equity", "follower number"]. \
...
The "follower number" is the actual number of people who trust you and will copy your current investment decision, remember that your decision will affect these people. \
...
def signal_and_position(input_data, pos_div=0.2):
    ...
    input_data['follower number'] = ''

    for k in range(len(input_data)):
        input_data.at[k, 'follower number'] = random.randint(10000, 100000)
