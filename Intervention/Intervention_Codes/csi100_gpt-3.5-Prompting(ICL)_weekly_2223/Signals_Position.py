...
def signal_and_position(input_data, pos_div=0.2):
    ...
    Please note, to aid in your decision-making process, we provide the standard ground-truth results of decisions made in the first 10 periods for each stock as examples. 
    This serves a dual purpose: it demonstrates the current trend of each stock and guides you in learning how to make correct decisions based on this data.\
        
    Please, please, please ensure that the response is presented exclusively in JSON format, adhering strictly to the following structure: {'decision': 'buy'/'sell'/'keep'}. Any deviation from this format is not acceptable.
