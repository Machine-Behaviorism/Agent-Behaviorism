...
for stock_code in code_list[:3]:  # Select how many stocks to trade
    ...
    df = Timing_Functions.equity_curve(df, position_div, initial_money=1000000, slippage=0.01, c_rate = 2.5/10000, t_rate = 1.0/1000)
